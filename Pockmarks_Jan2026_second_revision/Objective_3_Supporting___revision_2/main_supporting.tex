...
\begin{figure}[h!]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{hk1ave_r1_pockmark_salinity.png}}
...
\begin{figure}[h!]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{c1ave_r1_pockmark_salinity.png}}
...
Note that the conduits scenario run for this analysis featured a pockmark conduit $K$ of 10 m/day, rather than the 1 m/day used in the main text.
...
Additionally, the Aquitard Conduits model was run with a pockmark conduit hydraulic conductivity of 10 m/day, rather than 1 m/day as in the main text.
