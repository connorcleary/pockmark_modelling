...
The rate and spatial distribution of submarine groundwater discharge can vary seasonally and through tidal stages \cite{taniguchi_submarine_2019, lee_submarine_2016, dulai_autonomous_2016}.
...
\caption{Pockmarks associated with groundwater flow in areas with offshore fresh groundwater or with ecosystems sustained by submarine groundwater discharge. Locations include the Skagerrak \protect\cite{andresen_longevity_2021, hubscher_seismic_2006},
 the Baltic Sea \protect\cite{hoffmann_complex_2020, matciak_pockmarks_2024, virtasalo_submarine_2019},
 the Corinth Gulf \protect\cite{christodoulou_active_2003},
 the Pearl River Delta \protect\cite{sheng_offshore_2023, zhu_types_2021},
 the U.S. Atlantic Margin \protect\cite{gustafson_aquifer_2019, goff_modern_2019},
 the Canterbury Bight \protect\cite{micallef_3d_2020, micallef_multiple_2022},
 and the Wellington Harbour \protect\cite{hoffmann_fresh_2023}.
...
The marine beds were deposited during the post-glacial Holocene during the last 10,000 years \cite{gyopari_lower_2014}.
...
\caption{(a) Geological model of the study area, containing the hydrostratigraphic units of interest, adapted from \protect\citeA{begg_revised_2023}.
...
(b) Interpolated thickness of the Petone Marine Distal aquitard in the study area, based on the pockmark bathymetry and three-dimensional geological model of \protect\citeA{begg_revised_2023}. (c) Proposed geological models of the pockmarks.}
...
\begin{table}[h!]
\centering
\caption{Calibrated hydraulic properties \protect\cite{bennett_hutt_2024}}
\begin{tabular}{llll}
\hline
...
and the three spring vents observed by \citeA{harding_characteristics_2000}.
...
\caption{Locations of higher hydraulic conductivity patches of the aquitard in the Patchy Aquitard model and conduits in the Aquitard Conduits model. Where these locations correspond to the six pockmarks identified by \protect\citeA{harding_characteristics_2000}, pockmark numbers are shown.}
...
where anomalous salinity and turbidity were detected in the water column \cite{hoffmann_fresh_2023}.
...
The high discharge fluxes observed at the spring vents by \citeA{harding_characteristics_2000}, and the narrow turbidity plumes observed by \citeA{hoffmann_fresh_2023} are most consistent with the Aquitard Conduits model.
