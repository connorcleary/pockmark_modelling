...
We compared these findings to salinity and discharge observations from Wellington Harbour and found that a range of geological models were needed to explain all observations,
...
\textbf{Keywords:} Numerical modeling, geological uncertainty, offshore fresh groundwater, sea-level rise, Wellington Harbour
...
At coastlines worldwide, the seaward slope of terrestrial hydraulic gradients causes fresh groundwater to discharge into the sea \citep{arevalo-martinez_ideas_2023, taniguchi_submarine_2019, moore_effect_2010}.
This flux is important, as it supports coastal ecosystems \citep{burnett_groundwater_2003, moore_effect_2010}.
Submarine groundwater discharge can be diffuse, or focused at submarine springs \citep{taniguchi_submarine_2019},
which occur at a variety of features, including: lava tubes \citep{swarzenski_observations_2017},
fractures \citep{bokuniewicz_direct_2008, taniguchi_temporal_2008}, paleochannels \citep{mulligan_role_2007},
karst cavities \citep{fleury_submarine_2007}, and pockmarks \citep{hoffmann_fresh_2023, schluter_spatial_2004}.
The rate and spatial distribution of submarine groundwater discharge can vary seasonally and through tidal stages \citep{taniguchi_submarine_2019, lee_submarine_2016, dulai_autonomous_2016}.
If the coastal hydraulic gradient is reversed, the submarine groundwater discharge associated with it would cease,
and subsequent seawater intrusion may lead to salinization of fresh groundwater resources \citep{werner_seawater_2013, taniguchi_submarine_2019}.
Under a reversal of the hydraulic gradient, preferential flow paths previously associated with springs may accelerate the salinization of coastal aquifers \citep{geng_preferential_2020, xu_long_2016, falls_hydrogeology_2005}.

Coastal settlements worldwide anticipate increasing pressure on groundwater resources from abstraction for water supply and industrial purposes, due to population growth and sea-level rise \citep{michael_science_2017, oude_essink_effects_2010}.
This increases the risk of salinization, which is concerning, as coastal aquifers provide fresh water for over one billion people  \citep{ferguson_vulnerability_2012}.
If coastal groundwater levels cannot rise with sea level, the component of fresh submarine groundwater discharge driven by seaward terrestrial hydraulic gradient would decrease \citep{morgan_sea-level_2024}.
This will also decrease the reduction in onshore groundwater head required to reverse flow at submarine springs,
increasing susceptibility to seawater intrusion \citep{werner_classification_2017}.

Pockmarks are depressions on the seafloor formed by the upward flow of gas or groundwater \citep{hovland_significance_2002}.
...
which reduces deposition rates and alters the sedimentary structure \citep{micallef_can_2023, zhang_review_2025}.
...
Pockmarks can indicate the presence of offshore fresh groundwater \citep{micallef_offshore_2021, post_offshore_2013, bertoni_seismic_2020, hoffmann_complex_2020}.
Submarine groundwater discharge at pockmarks influences seafloor biogeochemistry and microbial communities \citep{purkamo_impact_2022},
and submarine groundwater springs can also be hotspots for marine biodiversity \citep{burnett_economic_2017, alorda-kleinglass_social_2021}.

Offshore fresh groundwater has been proposed as an alternative water resource; however, seawater intrusion through pockmarks may be a key vulnerability of this resource \citep{bakken_submarine_2012, zamrsky_offshore_2022, gyopari_wellington_2018}.
...
or seawater intrusion through pockmarks, may have consequences for surrounding ecosystems \citep{purkamo_impact_2022}.
...
While submarine springs in karstic or volcanic settings may have obvious vents \citep{fleury_submarine_2007, swarzenski_observations_2017},
pockmarks are often found in fine-grained sediments \citep{goff_modern_2019, matciak_pockmarks_2024, hoffmann_complex_2020},
which may make the identification and characterization of any associated preferential flow paths more challenging.

\begin{figure}[h!]
\makebox[\textwidth][c]{\includegraphics[width=1.35\textwidth]{global_map}}
\caption{Pockmarks associated with groundwater flow in areas with offshore fresh groundwater or with ecosystems sustained by submarine groundwater discharge. Locations include the Skagerrak \protect\citep{andresen_longevity_2021, hubscher_seismic_2006},
 the Baltic Sea \protect\citep{hoffmann_complex_2020, matciak_pockmarks_2024, virtasalo_submarine_2019},
 the Corinth Gulf \protect\citep{christodoulou_active_2003},
 the Pearl River Delta \protect\citep{sheng_offshore_2023, zhu_types_2021},
 the U.S. Atlantic Margin \protect\citep{gustafson_aquifer_2019, goff_modern_2019},
 the Canterbury Bight \protect\citep{micallef_3d_2020, micallef_multiple_2022},
 and the Wellington Harbour \protect\citep{hoffmann_fresh_2023}.
 (b) shows the location of observations of low salinity groundwater and pockmarks at Puck Bay, one of two locations in the Baltic Sea. (c) shows the locations of observations of low salinity groundwater and pockmarks at Martha's Vineyard on the U.S. Atlantic Margin. * denotes that the pockmarks are only implicitly related to groundwater flow by their co-occurrence.}
\label{fig:pockmarks_global_map}
\end{figure}

The physical characteristics of pockmarks associated with groundwater flow vary.
They are generally found from within 1 km of the shoreline, e.g. \cite{virtasalo_submarine_2019}, to more than 100 km offshore at the edge of continental shelves,
e.g. \cite{goff_modern_2019}. They may be up to 100 m in diameter, and up to 15 m deep \citep{micallef_can_2023}.
Pockmarks may be formed as regular or elongated singular depressions, composite or chained depressions, depressions with a raised eye in their base \citep{hovland_significance_2002},
or contain smaller intra-pockmarks inside of them \citep{hoffmann_complex_2020}.
As well as being sites of submarine groundwater discharge, pockmarks can be associated with submarine landslides and slumps and can indicate fluid overpressure preceding earthquakes \citep{hovland_significance_2002}.

Currently, the only published study modeling groundwater discharge at pockmarks is that of \cite{kaleris_modelling_2002},
...
much like the influence of topography on groundwater discharge to surface water bodies, where discharge occurs at changes of slope \citep{winter_relation_1999}.
...
\cite{mulligan_role_2007} showed that, for offshore paleochannels, discharge characteristics are controlled by channel geometry and vertical hydraulic conductivity.
...
they are an imminent concern in many locations around the world \citep{michael_science_2017, ferguson_vulnerability_2012, zamrsky_global_2024}.
Where such conditions coincide with the occurrence of pockmarks \citep{mendecki_saltwater_2025},
...
The aquifer system is an alluvial sedimentary basin that extends 20 km along the Hutt Valley and beneath Wellington Harbour \citep{begg_revised_2023}.
Although the system is relatively small, it is generally representative of coastal unconsolidated groundwater systems,
which make up to 25\% of the global coastline \citep{zamrsky_geological_2020, zamrsky_global_2024}.
The system is recharged by the Hutt River as well as rainfall, and around 15\% of its discharge occurs offshore \citep{bennett_hutt_2024}.
A large proportion of offshore discharge is thought to occur at numerous springs and pockmarks, which are widespread across the harbour \citep{hoffmann_fresh_2023, harding_characteristics_2000}.
The aquifer system supplies on average 40\% of the Wellington metropolitan region's drinking water \citep{begg_revised_2023}.
...
due to the risk of seawater intrusion, meaning that protecting the existing onshore groundwater supply is imperative \citep{gyopari_wellington_2018, morgan_likelihood_2022}.
...
Because of the proximity of municipal drinking water wellfields to the foreshore, seawater intrusion is a major risk for aquifer management \citep{bennett_hutt_2024}.
To mitigate this risk, monitoring wells along the shoreline are used to ensure the offshore hydraulic gradient is maintained \citep{gyopari_lower_2014}.
...
especially considering the projected sea-level rise and the uncertain future of recharge conditions \citep{michael_science_2017, bennett_hutt_2024}.
...
The gravel aquifer was deposited during the last glaciation, approximately 30,000 years ago and is highly transmissive \citep{bennett_hutt_2024, gyopari_lower_2014, shulmeister_timing_2019}.
The aquifer is overlain by the Petone Marine Beds, which consist of three aquitard units, Upper, Distal, and Lower \citep{begg_revised_2023}.
...
The marine beds were deposited during the post-glacial Holocene during the last 10,000 years \citep{gyopari_lower_2014}.
...
The pockmarks were first observed around 1950, and do not appear to be changing in form over time \citep{harding_characteristics_2000, hoffmann_fresh_2023}.
\cite{hoffmann_fresh_2023} inferred through their observations that these pockmarks were formed by submarine groundwater discharge, weakening the surface sediments,
...
\caption{(a) Geological model of the study area, containing the hydrostratigraphic units of interest, adapted from \protect\cite{begg_revised_2023}.
Going downward, these are the Petone Marine Upper, Petone Marine Distal, and Petone Marine Lower aquitards, and the Upper Waiwhetū aquifer.
On the surface of Petone Marine Distal aquitard, several pockmarks are visible.
(b) Interpolated thickness of the Petone Marine Distal aquitard in the study area, based on the pockmark bathymetry and three-dimensional geological model of \protect\cite{begg_revised_2023}. (c) Proposed geological models of the pockmarks.}
\label{fig:pockmarks_info_composite}
\end{figure}

Two field studies of the Hutt River pockmarks have been undertaken.
\cite{hoffmann_fresh_2023} took sediment cores from three locations within the study area (Figure \ref{fig:pockmarks_info_composite}b).
...
\cite{harding_characteristics_2000} took measurements of the vertical velocity and salinity of the water column at the base of two of the pockmarks where spring vents were observed,
...
It should be noted that the discharge velocity observed at the spring vents exceeds the typical range of values reported in the literature by around one order of magnitude \citep{diego-feliu_combining_2025}.
...
At an exploration borehole further offshore than the study area, the salinity in the Upper Waiwhetū aquifer was observed to be $<$ 2 PSU \citep{gyopari_wellington_2018}.
Regional groundwater modeling indicates that the total pockmark spring discharge across the harbour is around 3000 m$^3$/day \citep{bennett_hutt_2024}.

\section{Methods}\label{methods}

\subsection{Numerical modeling}

Variable-density groundwater flow and salt transport are simulated using the finite-difference numerical solver MODFLOW6 \citep{langevin_documentation_2017},
...
$\rho$ is a function of the density of freshwater $\rho_f$ [kg/m$^3$] and  $C$: $\rho = \rho_f + 0.7143C$.
 ...
 Models are built, run, and post-processed using the Python package FloPy \citep{bakker_scripting_2016}.
...
which would lead to an overestimate of the salt transport rate into the aquitard \citep{smith_mixed_2004, irvine_upstream_2021}.
...
While some back dispersion may still occur due to numerical error \citep{woods_numerical_2003}, these effects appear to be minimal (Supporting Information Figure 1).

\subsection{Geological model and hydraulic properties}
The MODFLOW6 hydrogeological model used in this study is derived from a geological model of the Hutt Valley and Wellington Harbour \citep{begg_revised_2023}.
This model was built using the Leapfrog geological modeling software \citep{seequent_ltd_leapfrog_2020},
...
and a series of seismic surveys, which were used to delineate the upper and lower contact surfaces of the Upper Waiwhetū aquifer \citep{stantec_gear_2022, begg_lower_2020}.
However, there is significant uncertainty as to the spatial extent of the modeled hydrostratographic units.
The topography of the geological model (Figure \ref{fig:pockmarks_info_composite}a) was created by merging the nationally available 250 $\times$ 250 m bathymetry \citep{niwa_new_2016} with a 5 $\times$ 5 m multibeam bathymetry survey of the Wellington harbour \citep{hoffmann_fresh_2023}.
...
HAM5 \citep{bennett_hutt_2024}.
Hydraulic properties in the regional groundwater model were calibrated using PEST$\_$HP \citep{doherty_pest_hp_2017}.
...
areas with pockmarks were represented by increasing the vertical hydraulic conductivity of the Petone Marine Distal aquitard \citep{kaleris_modelling_2002}.
...
\begin{table}[h!]
\centering
\caption{Calibrated hydraulic properties \protect\citep{bennett_hutt_2024}}
\begin{tabular}{llll}
\hline
...
As noted by \cite{hoffmann_fresh_2023}, the Hutt River pockmarks may be influenced by the heterogeneity of the Petone Marine Distal aquitard in the nearshore area.
...
Spring vents have also been noted by both \cite{harding_characteristics_2000} and \cite{hoffmann_fresh_2023}.
...
and contain several small discharge sites that are visible as plumes of more turbid water \citep{hoffmann_fresh_2023, harding_characteristics_2000}.
...
similar to the approach taken by \cite{kaleris_modelling_2002}.
...
This is within the range of expected values for the Petone Distal \citep{bennett_hutt_2024},
...
The eight regions correspond to the six pockmarks identified by \cite{harding_characteristics_2000}, and the two locations outside of these pockmarks where \cite{hoffmann_fresh_2023} collected sediment cores.
...
This hydraulic conductivity value represents the upper end of expected values for high-void ratio silt sediments \citep{zhu_experimental_2021},
which is consistent with the description of the spring vent sites \citep{hoffmann_fresh_2023, harding_characteristics_2000}.
The conduits have a diameter of around 1-2 m \citep{harding_characteristics_2000}.
These correspond to the locations where \cite{hoffmann_fresh_2023} collected sediment cores,
and the three spring vents observed by \cite{harding_characteristics_2000}.
...
\caption{Locations of higher hydraulic conductivity patches of the aquitard in the Patchy Aquitard model and conduits in the Aquitard Conduits model. Where these locations correspond to the six pockmarks identified by \protect\cite{harding_characteristics_2000}, pockmark numbers are shown.}
...
\hline
Patch & $3.6 \times 10^{-5}$ & 8 & Pockmark footprint & \cite{bennett_hutt_2024} \\
Conduits & $1$ & 6 & 1 m to 2 m diameter & \cite{hoffmann_fresh_2023, harding_characteristics_2000, zhu_experimental_2021} \\
\hline
\end{tabularx}
...
The grid is exported using the Leapfrog Hydrogeology module, then imported into FloPy \citep{hughes_flopy_2024}.
...
as shown in Figure 2.1 and Table 5.7 of \cite{gyopari_wellington_2018}.
...
The present-day scenario corresponds to when \cite{hoffmann_fresh_2023} took observations of porewater salinity in sediment cores and water column salinity.
...
based on the Shared Socioeconomic Pathways scenario SSP5-8.5 \citep{bennett_hutt_2024}.
...
This is because extraction volumes from this aquifer are actively managed with groundwater trigger levels.
...
At the end of these 105 years, the model may not have reached a new steady-state, and head and salinity distributions may still be equilibrating with the updated forcing conditions \citep{lu_timescales_2013}.
The value for $h_{\mathrm{sea}}$ reflects the predicted sea level elevation in NZVD, based on the Shared Socioeconomic Pathways scenario SSP5-8.5 \citep{nzsearise_takiwa_2023}.
The value for $h_{\mathrm{on}}$ is based on the modeled average summer groundwater level at McEwan Park under this sea-level rise scenario from HAM5 \citep{bennett_hutt_2024}.
...
The length of the Aquifer Depletion scenario reflects a possible situation where low aquifer heads are maintained for an extended period of one year \citep{gyopari_lower_2014}.
...
The value for $h_{\mathrm{off}}$ is based on the modeled hydraulic gradient between the McEwan Park and Somes Island monitoring wells, based on the modeled response of the aquifer to depletion \citep{gyopari_lower_2014}.
...
A head reduction of this magnitude is larger than that permitted under current aquifer management, which maintains a seaward gradient at the shoreline monitoring wells \citep{gyopari_lower_2014},
...
The simulated groundwater flux and salinity from each of the models are compared to the two flux observations \citep{harding_characteristics_2000},
and three salinity observations \citep{hoffmann_fresh_2023}. The following assumptions have been made in the comparison between the numerical model and the observations.

The flux observations were recorded as the vertical velocity of the water column,
which was taken in a cylindrical drum placed over the discharge sites \citep{harding_characteristics_2000}.
...
This also ignores the velocity variation caused by many small plumes of discharged groundwater, which have been observed \citep{harding_characteristics_2000}.
...
The salinity observations are profiles of salinity over 0.5 m deep sediment cores \citep{hoffmann_fresh_2023}.
We assume that the salinity in these profiles is driven only by uniform vertical groundwater flow.
This ignores the effects of horizontal groundwater flow and pore-scale groundwater dynamics, such as preferential flow paths, and porewater exchange \citep{taniguchi_submarine_2019}.
...
which is also 0.5 m deep. We chose not to compare the full salinity profiles of \cite{hoffmann_fresh_2023}, which included points at around 10 depths that were unevenly spaced at increments of around 0.05 m,
...
especially given the inherent uncertainty in bathymetry and the assumption of lithologically uniform hydraulic properties beneath the measurement points.
...
Because the upward flux is small, salt diffuses downwards into the aquitards \citep{jiao_reconstructed_2015}.
...
While dispersion is not expected to occur upgradient (downwards) from the seafloor boundary \citep{irvine_upstream_2021},
...
For all models, if mechanical dispersion was included, the amount of seawater intrusion would be expected to be greater \citep{werner_seawater_2013}.

\begin{figure}[h!]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{alternative_hypotheses_changes.png}}
\caption{(a-i) Salinity distribution and discharge rates at Pockmark 3 for the Thin Aquitard Model, the Patchy Aquitard Model, and the Aquitard Conduits model for the present-day, aquifer depletion, and sea-level rise scenarios. (j) Total pockmark discharge for the present-day and sea-level rise (2130) scenarios.}
...
This is consistent with findings from the modelling studies of \cite{kaleris_modelling_2002} and \cite{mulligan_role_2007}, who both observed greater flow at the edges of preferential flow features.
...
The observation of increased discharge at the edges of pockmarks may explain the formation of W-shaped pockmarks, such as those observed by \cite{matciak_pockmarks_2024}.
It also relates to the observation of \cite{harding_characteristics_2000} that spring vents were not only located in the centers of pockmarks.
...
Based on this, it is plausible that sampling the salinity of pockmarks could be used to identify the presence of offshore fresh groundwater \citep{hoffmann_fresh_2023, hoffmann_complex_2020}.
However, this is only likely to be effective where the offshore fresh groundwater is actively being discharged, and the advective flow rate is sufficient to prevent over-dominant diffusion \citep{micallef_offshore_2021}.
...
may be more likely to encounter low salinities. Additionally, areas of pockmarks where the seafloor texture is softer may be indicative of groundwater discharge \citep{harding_characteristics_2000, hoffmann_fresh_2023}.

We did not observe convection cells such as those seen by \cite{kaleris_modelling_2002} and \cite{mulligan_role_2007} in some of their simulations.
This is possibly caused by either too low hydraulic conductivity, or too high vertical flux preventing the onset of free convection \citep{greskowiak_tideinduced_2014}.
Additionally, the complex bathymetry may also dissipate any convective effects \citep{simmons_variable-density_2001}.
Further work could compare a model where pockmarks are represented through bathymetry, such as presented here,
with a model where pockmarks are represented parametrically by increasing the hydraulic conductivity of cells where they are located \citep{kaleris_modelling_2002},
for the same site.
This would help determine whether model abstraction may cause the erroneous occurrence of free convective cells.
...
Two of the salinity measurements of \cite{hoffmann_fresh_2023} were consistent with the Thin Aquitard model results,
...
where anomalous salinity and turbidity were detected in the water column \citep{hoffmann_fresh_2023}.
...
The high discharge fluxes observed at the spring vents by \cite{harding_characteristics_2000}, and the narrow turbidity plumes observed by \cite{hoffmann_fresh_2023} are most consistent with the Aquitard Conduits model.
None of the results of the three geological models were consistent with the flux measurements, and the total flux through all of the pockmarks was on the order of 1 m$^3$/day for the Aquitard Conduits model, which had the most discharge.
This is also significantly less than estimates of groundwater discharge at the pockmarks from regional modeling, 3000 m$^3$/day, across five areas with pockmarks in the harbour \citep{bennett_hutt_2024}.
...
This would be very high for the silt and sand Petone Marine hydrostratigraphic units, which still appear to be present beneath the incised pockmarks (Figure \ref{fig:pockmarks_info_composite}b).
...
Further sampling at the spring sites, such as the combined use of seepage meters and Amphibian Electrical Resistivity Tomography (AERT), may provide more reliable measurements of discharge rates to validate this \citep{diego-feliu_combining_2025}.
...
However, additional model runs including tidal forces show that tidal variation cannot explain the differences between the modelled salinities and fluxes with the observations of \cite{hoffmann_fresh_2023} and \cite{harding_characteristics_2000} (Supporting Information Figures 4 and 5).
...
With the recent focus on offshore fresh groundwater as a water resource \citep{bakken_submarine_2012, zamrsky_offshore_2022},
salinization of offshore groundwater through pockmarks may be a limiting factor for its exploitation \citep{gyopari_wellington_2018}.
...
The findings of \cite{hoffmann_fresh_2023} show that high hydraulic conductivity flow paths exist in the area of the Hutt River pockmarks that are not necessarily located inside of the pockmarks.
...
Consequently, the head in the fresh aquifer requires less of a reduction to reverse the equivalent freshwater head gradient and resulting flow \citep{post_variable_2022}.
...
meaning all pockmarks in the area have been identified \citep{hoffmann_fresh_2023}. In larger offshore environments such as continental shelves,
some of which hold large reserves of offshore fresh groundwater \citep{zamrsky_offshore_2022}, the identification of pockmarks and the risk of salinization through them will be more difficult \citep{goff_modern_2019, gustafson_aquifer_2019}.
This is because seismic surveys taken as transects of the system are only likely to encounter a small number of the existing pockmarks \citep{bertoni_seismic_2020}.
Furthermore, buried pockmarks that have been infilled with coarser sediment may be difficult to identify  \citep{goff_modern_2019}.
...
This is a result of surface drainage in the Hutt Valley, which causes the system to be partially topographically-limited \citep{bennett_hutt_2024, michael_global_2013}.
...
This is because of the increased equivalent freshwater head in the seafloor beneath the pockmarks \citep{post_variable_2022}.
...
pockmarks and submarine springs are hotspots for such ecosystems in other locations \citep{purkamo_impact_2022, idczak_geophysical_2020, taniguchi_submarine_2019}.
If sea-level rise caused a decrease in discharge in these locations, their ecosystems may be negatively impacted.
The presence of drains in coastal aquifer systems increases the impact of sea-level rise on submarine groundwater discharge and seawater intrusion vulnerability \citep{michael_global_2013, morgan_sea-level_2024, seibert_understanding_2024}.
...
because a small number of cores may not intersect localized high-conductivity paths whose extent is on the order of metres \citep{hoffmann_fresh_2023}.
...
Collecting conductivity profiles using geophysical methods such as controlled-source electromagnetic \citep{gustafson_aquifer_2019, micallef_3d_2020},
or continuous resistivity profile methods \citep{becker_locating_2023}, would help improve understanding of the distribution of fresh submarine groundwater discharge.
Such profiles should be recorded along different pockmark transects,
where submarine groundwater discharge had already been identified through anomalies in water-column measurements such as salinity and turbidity \citep{hoffmann_fresh_2023}.
...
and any associated heterogeneity \citep{reusch_giant_2015}.
To further understand the effect of tidal dynamics on discharge, continuous salinity and acoustic doppler current profiler (ADCP) measurements could be taken \citep{poulsen_detecting_2015}.
The collection of such data may allow for the development of a stochastic representation of aquitard heterogeneity \citep{van_leer_investigating_2025}.
...
The numerical model used is based on a hydrostratigraphic model that uses deterministic interpolation of discrete measurements \citep{begg_revised_2023}.
...
Using a stochastic representation of hydrostratigraphic units would help to quantify this uncertainty \citep{de_la_varga_gempy_2019, haehnel_development_2024, bardot_seamless_2025}.
...
This could either be through local grid refinement \citep{hughes_flopy_2024}, model splitting/nested models,
or through upscaling the results, potentially by finding the average flux across the area of regional model cells and calculating an effective vertical hydraulic conductivity \citep{van_leer_estimating_2023}.
